...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron">
			...
			<p>
				<a class="btn btn-lg btn-primary" href="/members/new">회원 가입</a> <a
					class="btn btn-lg btn-primary" href="/signup">상품 주문</a>
			</p>
			<p class="lead">관리자 기능2</p>
			<p>
				<a class="btn btn-lg btn-success" href="/signup">상품 등록</a> <a
					class="btn btn-lg btn-success" href="/signup">주문 내역</a>
			</p>
		</div>
